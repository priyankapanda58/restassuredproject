...
public class TC004_PUT_EditSingleEmployee extends TestBase {
	...
	{
		logger.info("*******Started TC004-Edit single Employee*******");
	...
	void tearDown()
	{
		logger.info("***********Finished TC004-PUT single employee details execution**********");
	}
}
